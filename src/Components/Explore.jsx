  ...
  return (
    <div className="max-w-screen-xl mx-auto py-16 px-3">
      <div className="grid grid-cols-[20%_auto] items-center gap-12">
        <div className="">
          <h4 className="text-[1.85rem] leading-tight font-semibold mb-4">
          ...
          <button className="font-semibold text-white bg-neutral-700 text-[0.94rem] rounded-full p-[4px_24px_5px]">
            Explore
          </button>
        </div>
        <div className=" grid grid-cols-3  items-center ">
          <div className="border-r border-neutral-200">
            ...
            <div className="text-[0.94rem]  text-center ">
          ...
          <div className=" ">
            ...
            <h4 className="font-semibold text-[0.94rem]">Nordiac Chair</h4>
            <h4 className="font-bold text-[1rem]">$100</h4>
            </div>
          </div>
        </div>
