    ...
    <div className="max-w-screen-xl mx-auto py-16 px-3">
      <div className="grid grid-cols-2 items-center">
        <div>
          ...
          <p className="text-[0.85rem] mb-10 font-light text-[#878787]">
          ...
          <div className="grid grid-cols-2 gap-4 text-justify">
            <div className="">
              <div>ICON</div>
              <p className="text-[0.94rem] mb-3 capitalize font-medium">
                Fast & free Shipping
              </p>
              <p className="text-[0.85rem] mb-4 font-light text-[#878787]">
