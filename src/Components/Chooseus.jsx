    ...
    <div className="max-w-screen-xl mx-auto py-6 sm:py-16 px-2 sm:px-3">
      <div className="lg:grid grid-cols-2 items-center">
        <div className="lg:mb-0 mb-4 sm:mb-10">
          <h4 className="capitalize text-[2rem] leading-tight font-semibold mb-4">
            {ChooseConst.HEADING}
          </h4>
          <p className="text-[1.24rem] mb-4 sm:mb-10 font-normal text-[#878787]">
            {ChooseConst.TITLE}
          </p>
          <div className="grid grid-cols-2 gap-2.5 sm:gap-4 ">
            {MultiItems.map((item, index) => (
              <div key={index} className="">
                ...
                <p className="text-[1.34rem] mb-2 capitalize font-semibold">
                  {item.TITLE}
                </p>
                <p className="text-[1.24rem] mb-2 sm:mb-4 font-normal text-[#878787]">
                  {item.SUBTEXT}
                </p>
              </div>
            ))}
